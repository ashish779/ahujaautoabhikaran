 ...
 <div id="slider-wrap">
        <div id="slider" class="carousel slide inner" data-ride="carousel" data-interval="3000"
            ...
            <div class="carousel-inner">
                <div class="item active">
                    <img data-desktop-src="{{ asset('public/images/banner/insurance-finance.jpg') }}" data-mobile-src="{{ asset('public/images/banner/mobile/insurance-finance.jpg') }}" alt="AHUJA AUTO ABHIKARAN Slide 1">
                </div>
            </div>
	...
	<option value="3">Credit Card</option>
                ...
                <div class="bg-grey text-center" style="background-color: rgb(243, 244, 246);">
                    <img src="{{ asset('public/images/verified/pci.jpg') }}" />
                    <img src="{{ asset('public/images/verified/norton.jpg') }}" />
                    <img src="{{ asset('public/images/verified/mastercard.jpg') }}" />
                    <img src="{{ asset('public/images/verified/verifiedbyvisa.jpg') }}" />
                    <img src="{{ asset('public/images/verified/ae.jpg') }}" />
                    <img src="{{ asset('public/images/verified/rupay.jpg') }}" />
                    <img src="{{ asset('public/images/verified/jcb.jpg') }}" />
                </div>
            </div>
