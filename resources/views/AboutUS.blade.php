        ...
        <div id="slider" class="carousel slide" data-ride="carousel" data-interval="3000" data-pause="false">
            <div class="carousel-inner">
                <div class="item active">
                    <img data-mobile-src="{{asset('public/images/who-we-are1.jpg')}}" data-desktop-src="{{asset('public/images/who-we-are1.jpg')}}" alt="">
                </div>
               <div class="item">
                    <img data-mobile-src="{{asset('public/images/who-we-are2.jpg')}}" data-desktop-src="{{asset('public/images/who-we-are2.jpg')}}" alt="">
                </div>
                      ...
                      <div class="picsgrid">
                        ...
                        <div class="col-sm-4 col-md-3 col-xs-6">
                            <a href="#" class="feather" data-featherparent="workshop">
                                <img src="{{asset('public/images/1.jpg')}}" /></a>
                        </div>
                        <div class="col-sm-4 col-md-3 col-xs-6">
                            <a href="#" class="feather" data-featherparent="workshop">
                                <img src="{{asset('public/images/2.jpg')}}" /></a>
                        </div>
                        <div class="col-sm-4 col-md-3 col-xs-6">
                            <a href="#" class="feather" data-featherparent="workshop">
                                <img src="{{asset('public/images/3.jpg')}}" /></a>
                        </div>
                        <div class="col-sm-4 col-md-3 col-xs-6">
                            <a href="#" class="feather" data-featherparent="workshop">
                                <img src="{{asset('public/images/4.jpg')}}" /></a>
                        </div>
                        <div class="col-sm-4 col-md-3 col-xs-6">
                            <a href="#" class="feather" data-featherparent="workshop">
                                <img src="{{asset('public/images/5.jpg')}}" /></a>
                        </div>
                        <div class="col-sm-4 col-md-3 col-xs-6">
                            <a href="#" class="feather" data-featherparent="workshop">
                                <img src="{{asset('public/images/6.jpg')}}" /></a>
                        </div>
                         <div class="col-sm-4 col-md-3 col-xs-6">
                            <a href="#" class="feather" data-featherparent="workshop">
                                <img src="{{asset('public/images/7.jpg')}}" /></a>
                        </div>
                        <div class="col-sm-4 col-md-3 col-xs-6">
                            <a href="#" class="feather" data-featherparent="workshop">
                                <img src="{{asset('public/images/8.jpg')}}"/></a>
                        </div>
                        <div class="col-sm-4 col-md-3 col-xs-6">
                            <a href="#" class="feather" data-featherparent="workshop">
                                <img src="{{asset('public/images/9.jpg')}}"/></a>
                        </div>
                            <div class="col-sm-4 col-md-3 col-xs-6">
                            <a href="#" class="feather" data-featherparent="workshop">
                                <img src="{{asset('public/images/10.jpg')}}"/></a>
                        </div>
                    </div>
